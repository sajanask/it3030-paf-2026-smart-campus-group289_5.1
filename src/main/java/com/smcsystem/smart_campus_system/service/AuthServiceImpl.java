...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse register(RegisterRequest request) {
        ...
        if (request.getRegistrationType() == RegistrationType.TECHNICIAN) {
            throw new BadRequestException("Technician registration must be completed with Google");
        }
